...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        // Note: Cannot reliably reverse pending_dept_head → pending_team_leader
        // as the original pending_dept_head tickets would be indistinguishable.
        ...
        // Note: We cannot know which team_leaders were originally pfa,
        // so rollback only restores the constraint with pfa allowed.
        DB::statement("
            ALTER TABLE users ADD CONSTRAINT users_role_check
