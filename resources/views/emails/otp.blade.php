...
<head>
  ...
  <title>Kode OTP — E-Procurement BNI</title>
</head>
          ...
          <tr>
            <td style="background:#006885;padding:28px 36px;">
              ...
              <div style="color:rgba(255,255,255,0.75);font-size:12px;margin-top:4px;">
                Divisi IT Infrastructure Management · E-Procurement System
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 36px 28px;">
              ...
              <p style="margin:0 0 24px;font-size:14px;color:#555;line-height:1.6;">
                Berikut adalah kode OTP untuk verifikasi akun E-Procurement BNI Anda.
              ...
              <p style="margin:24px 0 8px;font-size:13px;color:#888;text-align:center;">
                Jangan bagikan kode ini kepada siapapun, termasuk pihak BNI.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 36px;background:#f9fbfc;">
              <p style="margin:0;font-size:11px;color:#aaa;text-align:center;line-height:1.6;">
                Email ini dikirim secara otomatis oleh Sistem E-Procurement BNI.<br>
